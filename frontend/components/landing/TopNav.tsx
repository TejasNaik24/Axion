...
export default function TopNav({ repoUrl = "https://github.com/TejasNaik24/Axion" }: { repoUrl?: string }) {
        ...
        <>
            ...
            >
                ...
                <div
                    ...
                    style={{
                        backgroundImage: "linear-gradient(120deg, rgba(0,240,216,0.5) 0%, transparent 40%, rgba(124,76,255,0.5) 100%)",
                ...
                >
                    <AxionOrbMini />
                    <span className="font-bold text-lg tracking-tight text-white group-hover:text-accent1 transition-colors">Axion</span>
                </Link>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Link href="#" className="relative px-5 py-2 rounded-full bg-white text-bg font-semibold text-sm hover:scale-105 transition-transform">
                        Sign Up
                    </Link>
                </div>
            </motion.nav>
            ...
            <AnimatePresence>
                {isMobileMenuOpen && (
                    ...
                    >
                        <Link href="/" onClick={() => setIsMobileMenuOpen(false)} className="text-2xl font-bold flex items-center gap-2">
